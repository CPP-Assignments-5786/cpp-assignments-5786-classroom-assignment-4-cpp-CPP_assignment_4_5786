...
int main() {
    ...
    // --- 6. STREAM OPERATORS (I/O) ---
    cout << "\n=== 6. STREAM OPERATORS (<<, >>) ===" << endl;
    
    Grade g18(92.5);
    cout << "Output using <<: " << g18 << endl;                // Expected: 92.50 (A)
    
    cout << "Enter a grade score (e.g., 78.5): ";
    Grade g19;
    // cin >> g19;  // Uncomment for interactive input
    g19 = Grade(78.5); // For demo purposes
    cout << "Input grade: " << g19 << endl;                    // Expected: 78.50 (C)
    ...
    // --- 14. STREAM OPERATORS (on Student) ---
    cout << "\n=== 14. STREAM OPERATORS (Student I/O) ===" << endl;
